...
import { obtenerUsuarioPorId , actualizarDatosUsuario, eliminarUsuario, obtenerUsuarioPorCorreo, actualizarUsuarioInvitado} from "../services/usuariosService.js";
...
export const convertirInvitadoController = async (request, response) => {
    ...
    if (!datos.correo || !datos.contrasena) {
        return response.status(400).json({
            ...
            error: { 
                code: 400, 
                message: "Se requieren 'correo' y 'contrasena' validos." }
        });
    }
